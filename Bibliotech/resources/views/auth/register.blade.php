...
<div class="container-fluid col-md-8 mt-4">
    <h1 class="fs-2 text-center" style="color: #2CA19A;">{{ __('Register') }}</h1>
<form class="mt-3" action="/register" method="POST">
    ...
    <div class="row mb-1">
        <div class="col-md-6 offset-md-4">
            <button type="submit" class="col-md-5 btn rounded-pill text-light" style="background-color: #2CA19A;">{{ __('Register') }}</button>
        </div>
    </div>
