        ...
        <div class="row justify-content-end">
            <form action="/search" class="col-md-4">
                <div class="input-group mt-4">
                    <input type="search" class="form-control rounded" name="q" id="search" placeholder="Search by book's name" aria-label="Search" aria-describedby="search-addon" />
            ...
            @forelse ($books as $b)
                <div class="col-md-3 mt-2">
                    <div class="card shadow" style="background-color: {{PRIMARY_COLOR}};">
                        <a href="/detail/{{$b->id}}"><img class="card-img-top" style="width: 100%; height: 250px; object-fit: cover;" src="{{Storage::url('images/'.$b->image)}}" alt="{{$b->title}}"></a>
